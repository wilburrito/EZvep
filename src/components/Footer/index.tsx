      ...
      <Modal
        ...
        >
          <div style={{ maxHeight: "400px", overflowY: "auto", paddingRight: "10px" }}>
            <p><strong style={{ fontSize: "1.1em" }}>Payment Terms</strong><br />Payment is required when the invoice is issued. Payment can be made via the instructions on the invoice.</p>
            <p><strong style={{ fontSize: "1.1em" }}>Processing Queue</strong><br />After payment is confirmed, your application will begin processing.</p>
